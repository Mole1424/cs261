	...
	while True:
		...
		if result_sentiment >= lowerSentiment and result_sentiment <= upperSentiment:
			if show_pass:
				...
				print_sentiment_debug(lowerSentimentLabel, upperSentimentLabel, result_label, result_score)
				print("\033[0m", end='')
				print(BUFFER)
		else:
			if show_fail:
...
def print_sentiment_debug(lowerSentimentLabel, upperSentimentLabel, result_sentiment, result_score):
	print("Expected Sentiment between: ", lowerSentimentLabel, " and ", upperSentimentLabel)
